...
public class EditForm {
    ...
    public JTextField editTagField;
    ...
    AppConfig appConfig = new AppConfig();
        ...
        public JPanel createEditPanel() {
            ...
            editTagField = new JTextField(20);
            ...
            gbc.gridx = 1;
            editPanel.add(editTagField, gbc);
            ...
            editButton.addActionListener(_ -> {
                try {
                    appConnection.editPassword(this, passId);
                    clearFields();
    ...
    private void clearFields() {
        ...
        editDomainField.setText("");
        editTagField.setText("null");
    }
}
